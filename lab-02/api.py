...
vigenere_ceipher = VigenereCipher()
railfence_cipher = RailFenceCipher()
playfair_cipher = PlayfairCipher()
tranposition_cipher = TranspositionCipher()
...
def vigenere_encrypt():
    ...
    plain_text = data['plain_text']
    key = data['key']                   
    encrypted_text = vigenere_ceipher.vigenere_encrypt(plain_text, key)
...
def vigenere_decrypt():
    ...
    cipher_text = data['cipher_text']
    key = data['key']
    decrypted_text = vigenere_ceipher.vigenere_decrypt(cipher_text, key)
...
def transposition_encrypt():
    ...
    encrypted_text = tranposition_cipher.encrypt(plain_text, key)
    return jsonify({'encrypted_text': encrypted_text})
...
def transposition_decrypt():
    ...
    key = int(data.get('key'))
    decrypted_text = tranposition_cipher.decrypt(cipher_text, key)
    return jsonify({'decrypted_text': decrypted_text})
